...
export function usage(): string {
  ...
  return [
    ...
    "",
    "Environment:",
    "  MONASTERY_MODEL         default agent model (per-repo override wins; default: sonnet)",
    "  MONASTERY_REVIEW_MODEL  model for the reviewer role (default: MONASTERY_MODEL)",
    "",
    "Prerequisites: `gh` (logged in) and `claude` must be on your PATH.",
